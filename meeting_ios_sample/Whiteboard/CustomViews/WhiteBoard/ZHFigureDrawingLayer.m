...
+ (nullable instancetype)createLayerWithStartPoint:(CGPoint)startPoint
                                              type:(ZHFigureDrawingType)type {
...
{
    CGFloat xDist = fabs(endPoint.x - startPoint.x);
    CGFloat yDist = fabs(endPoint.y - startPoint.y);
